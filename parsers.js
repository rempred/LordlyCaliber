...
OB64.parseEnemydat = function(buf) {
  ...
  for (var r = 0; r < count; r++) {
    ...
    squads.push({
      ...
      itemOverrideA1: OB64.readU16BE(buf, off + 2),
      itemOverrideA2: OB64.readU16BE(buf, off + 4),
      posA:    buf[off + 6],
      classB:  buf[off + 7],
      levelOffsetB: buf[off + 8],
      itemOverrideB1: OB64.readU16BE(buf, off + 9),
      itemOverrideB2: OB64.readU16BE(buf, off + 11),
      posB1:   buf[off + 13],
      posB2:   buf[off + 14],
      posB3:   buf[off + 15],
      classC:  buf[off + 16],
      levelOffsetC: buf[off + 17],
      itemOverrideC1: OB64.readU16BE(buf, off + 18),
      itemOverrideC2: OB64.readU16BE(buf, off + 20),
      posC1:   buf[off + 22],
      posC2:   buf[off + 23],
      posC3:   buf[off + 24],
    });
