...
(function() {
  ...
  function classDefByteMap(r) {
    ...
    b(54, r.reqLevel);
    b(55, r.reqClass);
    b(56, r.reqClassLevel);
    b(57, r.additionalReqRaw !== undefined ? r.additionalReqRaw : r.additionalReq);
  ...
  function applyClassDefByte(r, off, value) {
    ...
    switch (off) {
      ...
      case 53: r.flagsRaw = value; syncAttacks(r); return;
      case 54: r.reqLevel = value; return;
      case 55: r.reqClass = value; return;
      case 56: r.reqClassLevel = value; return;
      case 57: r.additionalReqRaw = value; r.additionalReq = value; return;
      case 58: r.dragonElement = value; return;
      case 59: r.category = value; return;
      case 64: r.unitType = value; return;
