...
(async()=>{
 ...
 assert(state.sourceErrors['runtime-context:'+unsupported.assetId].includes('terminal resource class 6'));results.push({assetId:supported.assetId,runtime:true,passes:235,selectionRecovery:true,sameResourceRecovery:true,staleErrorCleared:true});
