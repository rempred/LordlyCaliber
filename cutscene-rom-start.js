...
(function(O){
 ...
 function dialoguePoint(l,actor,camera){
  ...
  if(actor.heightModeByte&1)fail('Dialogue origin requires the current terrain height.');
  ...
  const y=actor.heightModeByte&4?actor.y+actor.secondaryY:actor.heightModeByte&2?actor.secondaryY:actor.y;
