...
(function (OB64) {
  ...
  function hx4(value) { return '0x' + (value & 0xFFFF).toString(16).toUpperCase().padStart(4, '0'); }
  function signedOffset(raw) { return raw >= 0x80 ? raw - 0x100 : raw; }
  function readU16(rec, off) { return ((rec[off] << 8) | rec[off + 1]) & 0xFFFF; }
  function selectorLevelReadout(rec, role) {
  ...
  function injectStyle() {
    ...
    var css = [
      ...
      '#panel-squads .sq-titlebar h2{color:var(--ob-gold-bright);margin:0;font-size:var(--ob-text-lg);line-height:1.1}',
      '#panel-squads .sq-kpis{display:flex;gap:8px;flex-wrap:wrap;justify-content:flex-end}',
      '#panel-squads .sq-kpi{border:1px solid var(--ob-parchment-edge);background:var(--ob-parchment);color:var(--ob-ink);border-radius:6px;padding:5px 9px;font-size:var(--ob-text-sm);box-shadow:var(--ob-shadow-sm)}',
      ...
      '#panel-squads input.sq-search{width:100%;height:32px;border:1px solid var(--ob-parchment-edge);border-radius:5px;background:#f7ebce;color:var(--ob-ink);padding:0 9px;font-size:var(--ob-text-sm)}',
      '#panel-squads .sq-list-count{display:block;margin-top:5px;color:var(--ob-ink-soft);font-size:var(--ob-text-xs)}',
      '#panel-squads .sq-scn{font-size:var(--ob-text-sm);font-weight:700;color:var(--ob-ink-soft);margin:9px 2px 4px;display:flex;gap:8px;justify-content:space-between;align-items:center;cursor:pointer;text-transform:uppercase;letter-spacing:.4px}',
      ...
      '#panel-squads .sq-scn-name small{display:block;margin-top:1px;font-size:var(--ob-text-xs);font-weight:700;line-height:1.2;text-transform:none;letter-spacing:0;color:var(--ob-ink-soft);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}',
      ...
      '#panel-squads .sq-row{font-size:var(--ob-text-sm);color:var(--ob-ink);padding:7px 8px;border-radius:5px;cursor:pointer;display:grid;grid-template-columns:minmax(0,1fr) auto;gap:8px;align-items:center;border:1px solid transparent}',
      ...
      '#panel-squads .sq-chip{display:inline-flex;align-items:center;min-height:17px;border-radius:4px;padding:1px 5px;font-size:var(--ob-text-xs);font-weight:700;line-height:1;text-transform:uppercase;letter-spacing:.35px;background:var(--ob-parchment-dark);color:var(--ob-ink)}',
      ...
      '#panel-squads .sq-head{font-size:var(--ob-text-md);font-weight:700;color:var(--ob-ink);line-height:1.2}',
      '#panel-squads .sq-sub{font-size:var(--ob-text-sm);color:var(--ob-ink-soft);margin-top:3px;line-height:1.35}',
      ...
      '#panel-squads .sq-info-value{font-size:var(--ob-text-sm);font-weight:700;color:var(--ob-ink);line-height:1.35;overflow-wrap:anywhere}',
      ...
      '#panel-squads .sq-edat-line-title{min-width:0;font-size:var(--ob-text-sm);font-weight:700;color:var(--ob-ink);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}',
      '#panel-squads .sq-edat-line-sub{min-width:0;font-size:var(--ob-text-xs);color:var(--ob-ink-soft);margin-top:1px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}',
      '#panel-squads .sq-toggle{display:flex;gap:8px;align-items:center;font-size:var(--ob-text-sm);padding:8px 10px;border:1px solid var(--ob-parchment-edge);border-radius:6px;margin:0 0 12px;color:var(--ob-ink);background:#f7ebce;max-width:max-content}',
      ...
      '#panel-squads .sq-level-readout{border:1px solid var(--sq-line);border-radius:5px;background:rgba(255,255,255,.14);padding:6px 8px;margin-top:7px}',
      '#panel-squads .sq-level-readout strong,#panel-squads .sq-level-readout small{display:block}',
      ...
      '#panel-squads .sq-item-picker{display:grid;grid-template-columns:32px minmax(0,1fr) auto;gap:8px;align-items:center;width:100%;min-height:50px;padding:6px 9px;text-align:left;border:1px solid var(--ob-wood-darkest);border-radius:6px;background:linear-gradient(180deg,var(--ob-parchment) 0%,var(--ob-parchment-2) 55%,var(--ob-parchment-3) 100%);color:var(--ob-ink);cursor:pointer;text-shadow:0 1px 0 rgba(255,240,200,.45);box-shadow:inset 0 1px 0 rgba(255,245,210,.65),inset 0 -2px 0 rgba(122,81,32,.45),0 2px 3px rgba(0,0,0,.35);transition:filter .12s,transform .04s,box-shadow .12s}',
      '#panel-squads .sq-item-picker:hover{filter:brightness(1.08);border-color:var(--ob-gold)}',
      '#panel-squads .sq-item-picker:active{transform:translateY(1px);box-shadow:inset 0 2px 3px rgba(80,50,20,.55),0 1px 2px rgba(0,0,0,.35)}',
      '#panel-squads .sq-item-picker:focus-visible{outline:2px solid var(--ob-gold-bright);outline-offset:2px}',
      '#panel-squads .sq-item-picker:disabled{opacity:.52;cursor:not-allowed;filter:grayscale(.35);transform:none;border-color:var(--ob-wood-darkest)}',
      '#panel-squads .sq-item-picker img,#panel-squads .sq-item-picker-empty{width:28px;height:28px;object-fit:contain;image-rendering:pixelated;background:rgba(255,245,210,.28);border:1px solid rgba(91,58,24,.38);border-radius:4px;box-shadow:inset 0 1px 2px rgba(255,255,255,.45)}',
      ...
      '#panel-squads .sq-item-picker-action{font-family:var(--ob-display);font-size:var(--ob-text-xs);font-weight:800;letter-spacing:.45px;text-transform:uppercase;color:var(--ob-wax-red);padding:3px 5px;border:1px solid rgba(91,58,24,.32);border-radius:4px;background:rgba(255,245,210,.24)}',
      ...
      '#panel-squads .sq-action-row button{font-size:var(--ob-text-sm);white-space:nowrap}',
      '#panel-squads .sq-readout{min-width:0;padding-top:2px}',
      '#panel-squads .sq-foot{font-size:var(--ob-text-sm);color:var(--ob-ink-soft);margin-top:12px;padding-top:9px;border-top:1px solid var(--sq-line);display:flex;justify-content:space-between;gap:10px;flex-wrap:wrap}',
      '#panel-squads .sq-status{font-weight:700;color:#1f5f3c}',
      '#panel-squads .sq-warn{font-weight:700;color:var(--ob-wax-red)}',
      '#panel-squads .sq-notice{margin-top:10px;border:1px solid var(--ob-wax-red);background:rgba(152,32,24,.10);color:var(--ob-wax-red);border-radius:5px;padding:7px 9px;font-size:var(--ob-text-sm)}',
      '#panel-squads .sq-empty{color:var(--ob-ink-soft);font-size:var(--ob-text-sm);padding:14px 4px}',
  ...
  function pickersHtml(rec, rom) {
    ...
    ['B', 'C'].forEach(function (role) {
      ...
      h += '<div class="sq-field"><label>' + esc(label) + '</label><div class="sq-group-row">' +
        ...
        '</div>' + selectorLevelReadout(rec, role) +
        '<div class="sq-field-help">One level offset is shared by every occupied Member ' + role + ' cell. There is no per-occupant level field.</div></div>';
    });
    h += '</div>';
    return h;
  }
